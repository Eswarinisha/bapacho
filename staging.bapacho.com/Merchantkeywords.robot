...
Login_as_Merchant
        ...
        SeleniumLibrary.Input Text    username    ${Merchant with Online payment Credentials}[0]
        Input Password    password     ${Merchant with Online payment Credentials}[1]  
...
Login_as_Merchant without online payment
        ...
        Click Element    ${LoginasMerchant_${Language}} 
        BuiltIn.Sleep    2 
        SeleniumLibrary.Input Text    username   ${Merchant_Without_OnlinePayment_Credentials}[0]
        Input Password    password     ${Merchant_Without_OnlinePayment_Credentials}[1]  
...
Change order status to Cancel
    ...
    Capture Page Screenshot      
    Click Button    ${btn_OrderStatusSubmit} 
    Capture Page Screenshot
     BuiltIn.Sleep    2 
    Wait Until Page Contains Element    //button[contains(.,'OK')]    
    Click Element    //button[contains(.,'OK')]  
